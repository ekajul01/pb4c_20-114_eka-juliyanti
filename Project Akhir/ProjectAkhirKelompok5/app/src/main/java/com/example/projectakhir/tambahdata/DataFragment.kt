...
class DataFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        tabLayout = view.findViewById(R.id.tablayoutData)
        viewPager = view.findViewById(R.id.viewPagerData)

        viewPager.adapter = Fragment2Adapter(childFragmentManager) // Ganti dengan adapter kustom Anda sendiri
